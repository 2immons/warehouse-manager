<template>
  ...
  <div class="section-content">
    <div class="users-list">
      ...
      <div class="user-wrapper" v-for="(item, index) in filteredItems" :key="index">
        ...
        <div class="user__buttons">
          <button class="buttons__btn table-button--remove show-document">
          ...
          <button class="buttons__btn table-button--edit show-document">
    ...
    <div class="users-footer">
      <button class="buttons__btn add-document">Добавить пользователя</button>
    </div>
  </div>
</template>
